...
Revision ID: 06ba244489ee
Revises: 3491b989dccd
Create Date: 2025-09-29 21:53:54.833232
...
revision: str = '06ba244489ee'
down_revision: Union[str, Sequence[str], None] = '3491b989dccd'
...
def upgrade() -> None:
    ...
    op.add_column('embeddings', sa.Column('title', sa.String(length=500), nullable=False))
